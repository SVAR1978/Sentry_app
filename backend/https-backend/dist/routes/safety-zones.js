...
router.post("/seed", authenticateJWT, async (req, res) => {
    try {
        ...
        const seedData = [
            { areaName: "Connaught Place", safetyScore: 4.5, zoneLevel: "SAFE" },
            { areaName: "Hauz Khas", safetyScore: 4.3, zoneLevel: "SAFE" },
            { areaName: "Khan Market", safetyScore: 4.6, zoneLevel: "SAFE" },
            { areaName: "Lodhi Garden", safetyScore: 4.7, zoneLevel: "SAFE" },
            { areaName: "Chandni Chowk", safetyScore: 3.5, zoneLevel: "MODERATE" },
            { areaName: "Paharganj", safetyScore: 3.2, zoneLevel: "MODERATE" },
            { areaName: "Old Delhi Lanes", safetyScore: 3.0, zoneLevel: "MODERATE" },
            { areaName: "Karol Bagh", safetyScore: 3.8, zoneLevel: "MODERATE" },
            { areaName: "India Gate Area", safetyScore: 4.4, zoneLevel: "SAFE" },
            { areaName: "Saket", safetyScore: 4.2, zoneLevel: "SAFE" },
        ];
...
//# sourceMappingURL=safety-zones.js.map